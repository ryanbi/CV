...
\begin{tabular}{L!{\VRule}R}
\uppercase{Skills \HRule} & 
 \textbf{Bioinformatics and Biostatistics} NCBI tools, DNA sequence analysis, primer design, genomic data analysis and comparison, Roche 454 and AB 3730 sequencer, gene mapping and annotations, phylogenetics, various statistical analysis and programs.
\vspace{0.15in}
